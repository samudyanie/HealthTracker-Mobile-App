...
const ViewReports = () => {
  ...
  useEffect(() => {
    const getUserData = async () => {
      try {
        ...
        switch (reportType) {
          case "Blood Pressure":
            url = `http://172.20.10.7:5555/api/patient/getbloodpressurebydoc/${storedUser.doctornumber}`;
            break;
          case "Blood Sugar":
            url = `http://172.20.10.7:5555/api/patient/getbloodsugarbydoc/${storedUser.doctornumber}`;
            break;
          case "Lipid Profile":
            url = `http://172.20.10.7:5555/api/patient/getlipidbydoc/${storedUser.doctornumber}`;
            break;
          case "FBC":
            url = `http://172.20.10.7:5555/api/patient/getfbcbydoc/${storedUser.doctornumber}`;
            break;
          default:
  ...
  const handleViewHistory = async (patientId, type) => {
    ...
    switch (type) {
      case "Blood Pressure":
        url = `http://172.20.10.7:5555/api/patient/getbloodpressurebypatient/${patientId}`;
        columns = bpColumns;
        title = "Blood Pressure History";
        break;
      case "Blood Sugar":
        url = `http://172.20.10.7:5555/api/patient/getbloodsugarbypatient/${patientId}`;
        columns = sugarColumns;
        title = "Blood Sugar History";
        break;
      case "FBC":
        url = `http://172.20.10.7:5555/api/patient/getfbcbypatient/${patientId}`;
        columns = fbcColumns;
        title = "FBC History";
        break;
      case "Lipid Profile":
        url = `http://172.20.10.7:5555/api/patient/getlipidbypatient/${patientId}`;
  ...
  const handleCommentSubmit = async (docId, comment, type) => {
    ...
    switch (type) {
      case "Blood Pressure":
        url = `http://172.20.10.7:5555/api/patient/updatecomment/${docId}`;
        break;
      case "Blood Sugar":
        url = `http://172.20.10.7:5555/api/patient/updatebloodsugarcomment/${docId}`;
        break;
      case "FBC":
        url = `http://172.20.10.7:5555/api/patient/updatefbccomment/${docId}`;
        break;
      case "Lipid Profile":
        url = `http://172.20.10.7:5555/api/patient/updatelipidcomment/${docId}`;
        break;
      default:
        setLoading(false);
        return;
  ...
  const getRefreshUrl = (type, doctornumber) => {
    switch (type) {
      case "Blood Pressure":
        return `http://172.20.10.7:5555/api/patient/getbloodpressurebydoc/${doctornumber}`;
      case "Blood Sugar":
        return `http://172.20.10.7:5555/api/patient/getbloodsugarbydoc/${doctornumber}`;
      case "Lipid Profile":
        return `http://172.20.10.7:5555/api/patient/getlipidbydoc/${doctornumber}`;
      case "FBC":
        return `http://172.20.10.7:5555/api/patient/getfbcbydoc/${doctornumber}`;
      default:
        return "";
    }
  };
